...
translate crowdin Eric_talk_about_Kira_0_fb65eee0:
    ...
    # Eric_03 "Ну ты ушлый! Если это что-то, что поможет мне её трахнуть, то ты можешь рассчитывать на бонус. Так что у тебя там такое про неё имеется?" id Eric_talk_about_Kira_0_fb65eee0
    Eric_03 "Ну ты ушлый! Если это что-то, что поможет мне её трахнуть, то ты можешь рассчитывать на бонус. Так что у тебя там такое про неё имеется?" id Eric_talk_about_Kira_0_fb65eee0
...
translate crowdin strings:
    ...
    new "Кстати, как ты это делаешь?"

    # game/dialogues/erictalk.rpy:59
    old "Отлично! Спасибо, Эрик."
    new "Отлично! Спасибо, Эрик."
    ...
    new "{i}сесть на кровать{/i}"

    # game/dialogues/erictalk.rpy:160
    old "{i}слегка подвинуться{/i}"
    new "{i}слегка подвинуться{/i}"

    # game/dialogues/erictalk.rpy:220
    old "{i}смотреть, как мама сосёт{/i}"
    new "{i}смотреть, как мама сосёт{/i}"
    ...
    new "Нет, можешь обучать... (продолжение дружбы)"

    # game/dialogues/erictalk.rpy:322
    old "Нет, можешь обучать... (попытка подружиться)"
    new "Нет, можешь обучать... (попытка подружиться)"

    # game/dialogues/erictalk.rpy:322
    old "А ей не рановато? (попытка выиграть время)"
    new "А ей не рановато? (попытка выиграть время)"

    # game/dialogues/erictalk.rpy:322
    old "Лизу тебе не отдам! (расторжение дружбы)"
    new "Лизу тебе не отдам! (расторжение дружбы)"

    # game/dialogues/erictalk.rpy:322
    old "Лизу тебе не отдам! (продолжение вражды)"
    new "Лизу тебе не отдам! (продолжение вражды)"

    # game/dialogues/erictalk.rpy:454
    old "Значит, тебя её блог интересует? (продолжение дружбы)"
    new "Значит, тебя её блог интересует? (продолжение дружбы)"

    # game/dialogues/erictalk.rpy:454
    old "Я мало что об этом знаю... (попытка выиграть время)"
    new "Я мало что об этом знаю... (попытка выиграть время)"

    # game/dialogues/erictalk.rpy:454
    old "Не лез бы ты к Алисе! (расторжение дружбы)"
    new "Не лез бы ты к Алисе! (расторжение дружбы)"

    # game/dialogues/erictalk.rpy:454
    old "Нужна помощь? (попытка подружиться)"
    new "Нужна помощь? (попытка подружиться)"

    # game/dialogues/erictalk.rpy:454
    old "Вот у неё и спрашивай! (продолжение вражды)"
    new "Вот у неё и спрашивай! (продолжение вражды)"
